...
public class TimePickerUpdateAlarm extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        Alarm a = new Alarm(mAlarm.id, time, mAlarm.active, mAlarm.repeat, mAlarm.repeatDays, mAlarm.ringtoneUri, mAlarm.ringtoneTitle, mAlarm.vibrate, mAlarm.label);
        mCursorAdapter.updateAlarm(a, mPosition, true);
    }
}
